...
reset(){
  ...
  onSubmit(e) {
    ...
    }if(profileData.githubUsername===undefined || profileData.githubUsername===''){
          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">
                Remake your profile for it to stand out more!
              </p>
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="City or city & state suggested (eg. Tunis, Nabeul)"
                />
                <TextFieldGroup
                  placeholder="* Skills"
                  name="skills"
